...
yes | bash getparams.sh
$OPENNAC_DIR/auto_setup_opennac.sh /usr/share/opennac/.basic.data /usr/share/opennac/.globals.data /usr/share/opennac/.authrepositories.data
